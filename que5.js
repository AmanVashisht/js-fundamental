...
console.log("standard might take 3-5 days, express 1-2 days, and overnight would be delivered the next day.");

minday = 3+1+1;
maxday = 5+2+1;

console.log(`The estimated delivery time is ${minday} - ${maxday} days`)